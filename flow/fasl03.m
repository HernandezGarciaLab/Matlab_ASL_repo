function varargout = fasl03(varargin)
% fasl03 M-file for fasl03.fig
%      fasl03, by itself, creates a new fasl03 or raises the existing
%      singleton*.
%
%      H = fasl03 returns the handle to a new fasl03 or the handle to
%      the existing singleton*.
%
%      fasl03('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in fasl03.M with the given input arguments.
%
%      fasl03('Property','Value',...) creates a new fasl03 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before fasl02_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to fasl03_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @fasl03_OpeningFcn, ...
                   'gui_OutputFcn',  @fasl03_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before fasl03 is made visible.
function fasl03_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to fasl03 (see VARARGIN)

% Choose default command line output for fasl03
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes fasl03 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = fasl03_OutputFcn(hObject, eventdata, handles) 
