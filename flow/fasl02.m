function varargout = fasl02(varargin)
% fasl02 M-file for fasl02.fig
%      fasl02, by itself, creates a new fasl02 or raises the existing
%      singleton*.
%
%      H = fasl02 returns the handle to a new fasl02 or the handle to
%      the existing singleton*.
%
%      fasl02('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in fasl02.M with the given input arguments.
%
%      fasl02('Property','Value',...) creates a new fasl02 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before fasl02_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to fasl02_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @fasl02_OpeningFcn, ...
                   'gui_OutputFcn',  @fasl02_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before fasl02 is made visible.
function fasl02_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to fasl02 (see VARARGIN)

% Choose default command line output for fasl02
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes fasl02 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = fasl02_OutputFcn(hObject, eventdata, handles) 
