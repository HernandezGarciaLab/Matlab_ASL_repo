...
The bulk of you probably want to just process the ASL data that you collected at the lab, so here is the first thing you need to do: 
	step 1: download the software 
	step 2: include all the directories in your path.  (You will also need to include SPM12 and SPM12/toolbox/OldNorm/) 
	step 3: know where your data are, as well as the acquisition parameters for the pulse sequence. 
	step 4: from the Matlab command line, type : fasl03 . This will start the GUI.

There are several kinds of experiments that you may be processing.

1 - you collected PCASL data with the UM FMRI lab's stack of spirals sequence and now you want to calculate perfusion images and put them into MNI space.
	...
	UNder "spatial Transformations" , you will need to select images to 
		-coregister to structural: this is usually the anatomical T1 SPGR 
		-Normalise to Template : this is your T1 template from SPM. 
